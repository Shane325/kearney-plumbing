  ...
  if ($j('#contactform #email').val() != undefined) {
    if (validate_email($j('#contactform #email').val()) == false) {
      var hasClass = $j('#contactform #email').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">Please enter a valid email address</label>') }
  ...
  if ($j('#contactform #subject').val() != undefined) {
    if ($j('#contactform #subject').val() == '') {
      var hasClass = $j('#contactform #subject').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform #subject').parent().append('<label for="contactname" generated="true" class="error">You need to enter a subject!</label>') }
  ...
  if ($j('#contactform #name_s').val() != undefined) {
    if ($j('#contactform #name_s').val() == '') {
      var hasClass = $j('#contactform #name_s').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform #name_s').parent().append('<label for="contactname" generated="true" class="error">You need to enter your last name!</label>') }
...
function check_values_booking () {
  ...
  if ($j('#contactform_booking #email').val() != undefined) {
    if (validate_email($j('#contactform_booking #email').val()) == false) {
      var hasClass = $j('#contactform_booking #email').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform_booking #email').parent().append('<label for="contactname" generated="true" class="error">Please enter a valid email address</label>') }
  ...
  if ($j('#contactform_booking #surname').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_booking #surname').parent().append('<label for="contactname" generated="true" class="error">Please enter your surname</label>') }
  ...
  if ($j('#contactform_booking #arrival').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_booking #arrival').parent().append('<label for="contactname" generated="true" class="error">Please enter arrival date</label>') }
  ...
  if ($j('#contactform_booking #departure').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_booking #departure').parent().append('<label for="contactname" generated="true" class="error">Please enter departure date</label>') }
  ...
  if ($j('#contactform_booking #room').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_booking #room').parent().append('<label for="contactname" generated="true" class="error">Please enter your room nr</label>') }
  ...
  if ($j('#contactform_booking #children').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_booking #children').parent().append('<label for="contactname" generated="true" class="error">Please enter children nr</label>') }
  ...
  if ($j('#contactform_booking #body').val() != undefined) {
    if ($j('#contactform_booking #body').val() == '') {
      var hasClass = $j('#contactform_booking #body').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform_booking #body').parent().append('<label for="contactname" generated="true" class="error">You need to enter a message!</label>') }
...
function check_values_popup () {
  ...
  if ($j('#contactform_popup #name_popup').val() != undefined) {
    if ($j('#contactform_popup #name_popup').val() == '') {
	 	...
	 	if (!hasClass) { $j('#contactform_popup #name_popup').parent().append('<label for="contactname" generated="true" class="error">Please enter your name</label>') }
  ...
  if ($j('#contactform_popup #email_popup').val() != undefined) {
    if (validate_email($j('#contactform_popup #email_popup').val()) == false) {
      var hasClass = $j('#contactform_popup #email_popup').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform_popup #email_popup').parent().append('<label for="contactname" generated="true" class="error">Please enter a valid email address</label>') }
  ...
  if ($j('#contactform_popup #subject').val() != undefined) {
    if ($j('#contactform_popup #subject_popup').val() == '') {
      var hasClass = $j('#contactform_popup #subject_popup').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform_popup #subject_popup').parent().append('<label for="contactname" generated="true" class="error">You need to enter a subject!</label>') }
  ...
  if ($j('#contactform_popup #body_popup').val() != undefined) {
    if ($j('#contactform_popup #body_popup').val() == '') {
      var hasClass = $j('#contactform_popup #body_popup').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#contactform_popup #body_popup').parent().append('<label for="contactname" generated="true" class="error">You need to enter a message!</label>') }
  ...
  if ($j('#newsletterform #email_news').val() != undefined) {
    if (validate_email($j('#newsletterform #email_news').val()) == false) {
      var hasClass = $j('#newsletterform #email_news').parent().find('.error').hasClass('error')
	 	if (!hasClass) { $j('#newsletterform #email_news').parent().append('<label for="contactname" generated="true" class="error">Please enter a valid email address</label>') }
